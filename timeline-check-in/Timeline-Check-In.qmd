...
#Creating an ordered list of dominant species from highest to lowest mean cover
...
dominant_by_year <- saltmarsh_plants |>
  ...
  ungroup() |>
  #Ordering species so highest-cover species appear at the bottom of the stacked bars
  mutate(species_label = factor(species_label,
                                levels = dominant_species_order))
